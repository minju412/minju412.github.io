...
## 2. `application.yml`에 aws S3 접근 관련 내용 설정
```yml
cloud:
  aws:
    credentials:
...
# 포스트맨 테스트
<img width="1245" alt="스크린샷 2022-08-24 오후 5 42 29" src="https://user-images.githubusercontent.com/59405576/186372699-6c9e1cd1-fddb-41cd-b796-0e7cf58b8576.png"><br>

`KEY`에는 컨트롤러의 `savePost`의 파라미터 이름을 작성해주고,<br> 
`VALUE`에는 게시글 내용(`TEXT`)과 이미지 파일(`FILE`)을 첨부한 뒤,<br>
반드시 `CONTENT TYPE`을 명시해주어야 한다!<br><br>
