...
-Dspring.datasource.url='jdbc:mysql://ec2-13-124-66-164.ap-northeast-2.compute.amazonaws.com:3306/naem?serverTimezone=UTC&characterEncoding=UTF-8' \
-Dspring.datasource.username='root' \
-Dspring.datasource.password='naem2524!' \
...
`nohup java -jar server-0.0.1-SNAPSHOT.jar &` 처럼 설정하지 않으면 nohup.out으로 저장된다고 한다.
...
$ scp -i "/Users/minju/study/Naem/second-keypair.pem" build/libs/server-0.0.1-SNAPSHOT.jar ubuntu@ec2-13-124-66-164.ap-northeast-2.compute.amazonaws.com:~/
