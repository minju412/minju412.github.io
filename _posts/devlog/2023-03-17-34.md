---
title:  "[Docker] 프로젝트를 Docker Compose 환경으로 변경하기"
...
2. [젠킨스와 소나큐브 연동하기](https://minju412.github.io/devlog/32/)
3. [슬랙으로 젠킨스 알림 받기](https://minju412.github.io/devlog/33/)
...
## 1) 우분투 인스턴스 설정
<!-- ### aws-s3.yml copy 하기
> [이 글](https://nato-blog.tistory.com/138)을 참고했다. -->
