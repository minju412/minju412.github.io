...
> Spring Rest Docs를 적용하기 위해서 아래 글들을 참고했다.
...
# 4. 테스트 코드 빌드 후 확인
테스트 코드 안에서 실행 버튼을 클릭하자.<br>
테스트 코드가 통과되었다면 아래와 같은 파일이 자동으로 생성되었을 것이다.<br>
