---
title:  "[Route53] nginx + https 적용하기 "
...
last_modified_at: 2022-05-27 15:47:27
---
...
```
참고로 첨부한 것이며 나는 따로 변경하지는 않았다.<br>
```
user www-data;
...
# +) 고생했던 부분 🥵
처음에는 `sudo certbot certonly --nginx ` 대신 `sudo certbot --nginx` 명령을 실행했는데, 계속해서 아래와 같은 오류가 발생했다.<br>
```
...
```
<img width="1427" alt="스크린샷 2022-05-27 오후 1 11 50" src="https://user-images.githubusercontent.com/59405576/170640283-3c190da2-3e83-49a0-88a9-fe6aba032bba.png"> <br>
